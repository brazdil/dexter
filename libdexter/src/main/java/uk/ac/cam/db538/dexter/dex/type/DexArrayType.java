...
public class DexArrayType extends DexReferenceType {
	...
	private final DexRegisterType elementType;
	...
	public static DexArrayType parse(String typeDescriptor, DexTypeCache cache) {
		if (!typeDescriptor.startsWith("[")) throw new UnknownTypeException(typeDescriptor);
	...
	public String getJavaDescriptor() {
		if (elementType instanceof DexClassType) return "[L" + elementType.getPrettyName() + ";"; else return "[" + elementType.getDescriptor();
	}
	...
	public static String jvm2dalvik(String jvmName) {
		...
		} else throw new UnknownTypeException(jvmName);
	}
	
	@java.lang.SuppressWarnings("all")
	public DexRegisterType getElementType() {
