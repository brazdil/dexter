...
public class DexInstruction_ConstString extends DexInstruction {
	...
	public static DexInstruction_ConstString parse(Instruction insn, CodeParserState parsingState) {
		...
		if (insn instanceof Instruction21c && insn.opcode == Opcode.CONST_STRING) {
			final org.jf.dexlib.Code.Format.Instruction21c insnConstString = (Instruction21c)insn;
			...
			final org.jf.dexlib.Code.Format.Instruction31c insnConstStringJumbo = (Instruction31c)insn;
	...
	public String toString() {
		...
		if (escapedVal.length() > 15) escapedVal = escapedVal.substring(0, 15) + "...";
