...
public class InterfaceDefinition extends BaseClassDefinition {
	...
	private final Set<ClassDefinition> implementors;
	...
	public InterfaceDefinition(DexClassType classType, int accessFlags, boolean isInternal) {
		...
		if (!getAccessFlags().contains(AccessFlags.INTERFACE)) throw new HierarchyException("Class is not an interface");
	...
	public Set<ClassDefinition> getImplementors() {
