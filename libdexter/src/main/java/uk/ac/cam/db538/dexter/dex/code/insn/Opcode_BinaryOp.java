...
public enum Opcode_BinaryOp {
	...
	private final RegisterWidth widthResult;
	private final RegisterWidth widthArgA;
	private final RegisterWidth widthArgB;
	...
	public void checkRegisterType(DexRegister reg, Arg arg) {
		...
		if (reg.getWidth() != desiredWidth) throw new Error("Register width does not match instruction opcode"); else if (reg instanceof DexTaintRegister && this != OrInt) throw new Error("Only OR operation is allowed on taint registers");
	}
	
	@java.lang.SuppressWarnings("all")
	private Opcode_BinaryOp(final String AssemblyName, final RegisterWidth widthResult, final RegisterWidth widthArgA, final RegisterWidth widthArgB) {
		
		this.AssemblyName = AssemblyName;
		this.widthResult = widthResult;
		this.widthArgA = widthArgA;
		this.widthArgB = widthArgB;
	}
	...
	@java.lang.SuppressWarnings("all")
	public RegisterWidth getWidthResult() {
		return this.widthResult;
	}
	
	@java.lang.SuppressWarnings("all")
	public RegisterWidth getWidthArgA() {
		return this.widthArgA;
	}
	
	@java.lang.SuppressWarnings("all")
	public RegisterWidth getWidthArgB() {
		return this.widthArgB;
	}
}